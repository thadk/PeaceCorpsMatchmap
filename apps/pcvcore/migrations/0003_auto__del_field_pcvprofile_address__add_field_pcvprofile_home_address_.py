...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PCVProfile.address'
        db.delete_column(u'pcvcore_pcvprofile', 'address')

        # Adding field 'PCVProfile.home_address'
        db.add_column(u'pcvcore_pcvprofile', 'home_address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'PCVProfile.home_state'
        db.add_column(u'pcvcore_pcvprofile', 'home_state',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PCVProfile.address'
        db.add_column(u'pcvcore_pcvprofile', 'address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Deleting field 'PCVProfile.home_address'
        db.delete_column(u'pcvcore_pcvprofile', 'home_address')

        # Deleting field 'PCVProfile.home_state'
        db.delete_column(u'pcvcore_pcvprofile', 'home_state')
    ...
    models = {
        ...
        u'pcvcore.pcvprofile': {
            ...
            'home_address': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128', 'blank': 'True'}),
            'home_state': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '128', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
